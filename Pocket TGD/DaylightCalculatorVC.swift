...
class DaylightCalculatorVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        var labels:[UILabel] = [roomLengthLabel, roomDepthLabel, roomHeightLabel, windowLengthLabel, windowHeightLabel, extraInfoLabel]
        ...
        extraInfoLabel.text = "* Remember to exclude the storage units in primary school classrooms\n\nSee information at top right for further details."
